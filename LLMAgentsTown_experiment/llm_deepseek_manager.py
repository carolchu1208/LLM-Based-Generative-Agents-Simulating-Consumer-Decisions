...
class ModelManager(ModelManagerInterface):
    ...
    def _initialize(self):
        ...
        self.fallback_responses = {
            "daily_plan": """{
  "activities": [
    {"time": 7, "action": "go_to", "target": "[workplace]", "description": "Travel to work"},
    {"time": 8, "action": "work", "target": "[workplace]", "description": "Start work shift"},
    {"time": 9, "action": "work", "target": "[workplace]", "description": "Continue work"},
    {"time": 10, "action": "work", "target": "[workplace]", "description": "Continue work"},
    {"time": 11, "action": "work", "target": "[workplace]", "description": "Continue work"},
    {"time": 12, "action": "eat", "target": "[restaurant]", "description": "Lunch break"},
    {"time": 13, "action": "work", "target": "[workplace]", "description": "Resume work"},
    {"time": 14, "action": "work", "target": "[workplace]", "description": "Continue work"},
    {"time": 15, "action": "work", "target": "[workplace]", "description": "Continue work"},
    {"time": 16, "action": "work", "target": "[workplace]", "description": "Continue work"},
    {"time": 17, "action": "work", "target": "[workplace]", "description": "End work shift"},
    {"time": 18, "action": "go_to", "target": "[residence]", "description": "Travel home"},
    {"time": 19, "action": "eat", "target": "[residence]", "description": "Dinner at home"},
    {"time": 20, "action": "idle", "target": "[residence]", "description": "Relax at home"},
    {"time": 21, "action": "idle", "target": "[residence]", "description": "Evening relaxation"},
    {"time": 22, "action": "idle", "target": "[residence]", "description": "Wind down"},
    {"time": 23, "action": "rest", "target": "[residence]", "description": "Prepare for sleep"}
  ]
}""",
